    ...
    /* [out] */ String* str)
{
    ...
    String tmp;
    GetString(Elastos::Droid::TeleService::R::string::voicemail_abbreviated, &tmp);
    StringBuilder sb;
    sb += tmp;
    sb += " ";
    sb += vmDisplay;
...
void CCallFeaturesSetting::UpdateVoiceNumberField()
{
    ...
    if (mOldVmNumber.GetLength() > 0) {
        ...
        GetString(Elastos::Droid::TeleService::R::string::voicemail_number_not_set, &summary);
    }
    ...
    /* [in] */ Int32 id)
{
    if ((id == VM_RESPONSE_ERROR) || (id == VM_NOCHANGE_ERROR) ||
        ...
        Int32 msgId;
        Int32 titleId = Elastos::Droid::TeleService::R::string::error_updating_title;
        switch (id) {
            case VOICEMAIL_DIALOG_CONFIRM:
                msgId = Elastos::Droid::TeleService::R::string::vm_changed;
                titleId = Elastos::Droid::TeleService::R::string::voicemail;
                // Set Button 2
                b->SetNegativeButton(Elastos::Droid::TeleService::R::string::close_dialog, this);
                break;
            case VM_NOCHANGE_ERROR:
                // even though this is technically an error,
                // keep the title friendly.
                msgId = Elastos::Droid::TeleService::R::string::no_change;
                titleId = Elastos::Droid::TeleService::R::string::voicemail;
                // Set Button 2
                b->SetNegativeButton(Elastos::Droid::TeleService::R::string::close_dialog, this);
                break;
            case VM_RESPONSE_ERROR:
                msgId = Elastos::Droid::TeleService::R::string::vm_change_failed;
                // Set Button 1
                b->SetPositiveButton(Elastos::Droid::TeleService::R::string::close_dialog, this);
                break;
            case FW_SET_RESPONSE_ERROR:
                msgId = Elastos::Droid::TeleService::R::string::fw_change_failed;
                // Set Button 1
                b->SetPositiveButton(Elastos::Droid::TeleService::R::string::close_dialog, this);
                break;
            case FW_GET_RESPONSE_ERROR:
                msgId = Elastos::Droid::TeleService::R::string::fw_get_in_vm_failed;
                b->SetPositiveButton(Elastos::Droid::TeleService::R::string::alert_dialog_yes, this);
                b->SetNegativeButton(Elastos::Droid::TeleService::R::string::alert_dialog_no, this);
                break;
            default:
                msgId = Elastos::Droid::TeleService::R::string::exception_error;
                // Set Button 3, tells the activity that the error is
                // not recoverable on dialog exit.
                b->SetNeutralButton(Elastos::Droid::TeleService::R::string::close_dialog, this);
                break;
        }
        ...
        AutoPtr<ICharSequence> title;
        GetText(Elastos::Droid::TeleService::R::string::updating_title, (ICharSequence**)&title);
        IDialog::Probe(dialog)->SetTitle(title);
        dialog->SetIndeterminate(TRUE);
        IDialog::Probe(dialog)->SetCancelable(FALSE);

        AutoPtr<ICharSequence> message;
        GetText(id == VOICEMAIL_FWD_SAVING_DIALOG ? Elastos::Droid::TeleService::R::string::updating_settings :
                (id == VOICEMAIL_REVERTING_DIALOG ? Elastos::Droid::TeleService::R::string::reverting_settings :
                Elastos::Droid::TeleService::R::string::reading_settings), (ICharSequence**)&message);
...
ECode CCallFeaturesSetting::OnResume()
{
    ...
    AddPreferencesFromResource(Elastos::Droid::TeleService::R::xml::call_feature_setting);
    ...
    AutoPtr<IResources> resources;
    GetResources((IResources**)&resources);
    if (resources->GetBoolean(Elastos::Droid::TeleService::R::bool_::world_phone, &res), !res) {
        ...
        if (phoneType == IPhoneConstants::PHONE_TYPE_CDMA) {
            ...
            AutoPtr<IResources> resources;
            GetResources((IResources**)&resources);
            if (resources->GetBoolean(Elastos::Droid::TeleService::R::bool_::config_voice_privacy_disable, &res), !res) {
                AddPreferencesFromResource(Elastos::Droid::TeleService::R::xml::cdma_call_privacy);
            }
        }
        else if (phoneType == IPhoneConstants::PHONE_TYPE_GSM) {
            AutoPtr<IResources> resources;
            GetResources((IResources**)&resources);
            if (resources->GetBoolean(Elastos::Droid::TeleService::R::bool_::config_additional_call_setting, &res), res) {
    ...
    /* [in] */ Int32 TtyMode)
{
    ...
    resources->GetStringArray(Elastos::Droid::TeleService::R::array::tty_mode_entries, (ArrayOf<String>**)&txts);
    switch(TtyMode) {
        case ITelecomManager::TTY_MODE_OFF:
        case ITelecomManager::TTY_MODE_HCO:
        case ITelecomManager::TTY_MODE_VCO:
    ...
    /* [in] */ const String& currentProviderSetting)
{
    ...
    if (provider == NULL) {
        ...
        String str;
        GetString(Elastos::Droid::TeleService::R::string::sum_voicemail_choose_provider, &str);
        AutoPtr<ICharSequence> cs;
...
void CCallFeaturesSetting::InitVoiceMailProviders()
{
    ...
    String myCarrier;
    GetString(Elastos::Droid::TeleService::R::string::voicemail_default, &myCarrier);
