    ...
    /* [out] */ IInterface** result)
{
    ...
    *result = (IObject*)localeConfiguration;
    REFCOUNT_ADD(*result);
    return NOERROR;
}
...
void Launcher::SetupViews()
{
    ...
    view = NULL;
    IView::Probe(mDragLayer)->FindViewById(R::id::workspace, (IView**)&view);
    ...
    // Setup the hotseat
    view = FindViewById(Elastos::Droid::Launcher2::R::id::hotseat);
    mHotseat = IHotseat::Probe(view);
    if (mHotseat != NULL) {
        mHotseat->Setup(this);
    }
    ...
    view = NULL;
    IView::Probe(mDragLayer)->FindViewById(Elastos::Droid::Launcher2::R::id::qsb_bar, (IView**)&view);
    mSearchDropTargetBar = ISearchDropTargetBar::Probe(view);

    // Setup AppsCustomize
    view = FindViewById(Elastos::Droid::Launcher2::R::id::apps_customize_pane);
    ...
    /* [in] */ Boolean springLoaded)
{
    ...
    AutoPtr<IView> toView = IView::Probe(mAppsCustomizeTabHost);
    Int32 startDelay;
    res->GetInteger(
    ...
    if (animated) {
        ...
        (*array)[0] = 0.0f;
        (*array)[1] = 1.0f;
        AutoPtr<IObjectAnimator> alphaAnim = LauncherAnimUtils::OfFloat(toView,
                String("alpha"), array);
        ...
        if (delayAnim) {
            ...
            AutoPtr<IOnGlobalLayoutListener> listener2 = new MyOnGlobalLayoutListener(startAnimRunnable,
                    IAppsCustomizeTabHost::Probe(toView));
...
{
Slogger::E("Launcher", "[snow]=================TODO=========GetExternalPackageToolbarIcon ");
//     //try {
//     ECode ec;
//     AutoPtr<IPackageManager> packageManager;
